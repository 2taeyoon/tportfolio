...
export default function CodeCard({ project }: CodeCardProps) {
	...
	return (
		<div className={getClassName('code_card', project)} style={{ backgroundColor: project.boxColor }}>
			<div className="card_title" style={{ color: project.fontColor }}>{project.title}<span className="card_date">{project.date}</span></div>
